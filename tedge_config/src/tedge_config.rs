...
impl ConfigSettingAccessor<MqttExternalPortSetting> for TEdgeConfig {
    ...
    fn update(&mut self, _setting: MqttExternalPortSetting, value: Port) -> ConfigSettingResult<()> {
...
impl ConfigSettingAccessor<MqttExternalBindAddressSetting> for TEdgeConfig {
    ...
    fn update(&mut self, _setting: MqttExternalBindAddressSetting, value: String) -> ConfigSettingResult<()> {
...
impl ConfigSettingAccessor<MqttExternalBindInterfaceSetting> for TEdgeConfig {
    ...
    fn update(&mut self, _setting: MqttExternalBindInterfaceSetting, value: String) -> ConfigSettingResult<()> {
...
impl ConfigSettingAccessor<MqttExternalCAfileSetting> for TEdgeConfig {
    fn query(&self, _setting: MqttExternalCAfileSetting) -> ConfigSettingResult<FilePath> {
        self.data
            .mqtt
            .external_cafile
            .clone()
            .ok_or(ConfigSettingError::ConfigNotSet {
                key: MqttExternalCAfileSetting::KEY,
            })
    }

    fn update(
        &mut self,
        _setting: MqttExternalCAfileSetting,
        value: FilePath,
    ) -> ConfigSettingResult<()> {
        self.data.mqtt.external_cafile = Some(value);
        Ok(())
    }

    fn unset(&mut self, _setting: MqttExternalCAfileSetting) -> ConfigSettingResult<()> {
        self.data.mqtt.external_cafile = None;
        Ok(())
    }
}
